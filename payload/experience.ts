      ...
      positions: [
        {
          ...
          skillKeywords: ['PHP', 'JavaScript','TypeScript', 'HTML/CSS', 'AWS', 'MYSQL', 'Solidity','Truffle','Hardhat'],
        },
      ],
    },    
    {
      ...
      positions: [
        {
          ...
          skillKeywords: ['PHP', 'JavaScript', 'HTML/CSS', 'Linux', 'MYSQL', 'MSSQL', 'ORACLE', 'JAVA', 'CORS', 'RestFUL API', 'Security', 'Automation'],
        },
      ],
    },
    {
